...
#include "src/headers/mainWindows/mqttTest.h"
...
QT_MOC_LITERAL(1, 9, 17), // "onReportBtClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12) // "on_readyRead"

    },
    "mqttTest\0onReportBtClicked\0\0on_readyRead"
};
...
void mqttTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mqttTest *_t = static_cast<mqttTest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onReportBtClicked(); break;
...
const QMetaObject mqttTest::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_mqttTest.data,
      qt_meta_data_mqttTest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mqttTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mqttTest.stringdata0))
        return static_cast<void*>(const_cast< mqttTest*>(this));
